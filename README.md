...
The command list is intentionally compact. Draft, playoff, broad history, and weekly recap screens are intentionally left to Sleeper unless they are needed inside a focused team or player summary. Team-specific context lives in `/team`, player research lives in `/player`, and player-vs-player decisions live in `/compare`.
